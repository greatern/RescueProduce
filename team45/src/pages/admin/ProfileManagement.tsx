...
const ProfileManagement: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'profile' | 'password' | 'availability' | 'deactivate'>('profile');
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 border-b border-gray-200">
          <nav className="flex space-x-8">
            <button
              ...
              className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'profile' ? 'border-emerald-500 text-emerald-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
            >
            ...
            <button
              ...
              className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'password' ? 'border-emerald-500 text-emerald-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
            >
              <div className="flex items-center">
            ...
            {profile.role === 'Volunteer' && (
              <button
                ...
                className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'availability' ? 'border-emerald-500 text-emerald-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
              >
                <div className="flex items-center">
            ...
            <button
              ...
              className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'deactivate' ? 'border-emerald-500 text-emerald-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
            >
              <div className="flex items-center">
              ...
              {isEditing ? (
                ...
                <dl>
                  ...
                  {profile.role === 'Volunteer' && (
                    <>
                      <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border-t border-gray-200">
                        ...
                        <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{profile.vehicleType}</dd>
                      </div>
                      <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border-t border-gray-200">
                        <dt className="text-sm font-medium text-gray-500">Capacity</dt>
                        <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{profile.capacity}</dd>
                      </div>
                    </>
                  )}
                  {profile.role === 'NGO' && (
                    <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border-t border-gray-200">
                      ...
                      <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{profile.organization}</dd>
                    </div>
                  )}
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border-t border-gray-200">
                  ...
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border-t border-gray-200">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{profile.lastActive}</dd>
                  </div>
                </dl>
              )}
            </div>
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
              <form onSubmit={handlePasswordChange}>
                ...
                <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border-t border-gray-200">
                  <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-500">Confirm New Password</label>
                  <div className="mt-1 sm:mt-0 sm:col-span-2">
                    <input
                      type="password"
                      id="confirmPassword"
        ...
        {/* Availability Tab (Volunteers only) */}
        {activeTab === 'availability' && profile.role === 'Volunteer' && (
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
              <div className="flex justify-between items-center">
                <h3 className="text-lg leading-6 font-medium text-gray-900">Volunteer Availability</h3>
                <button
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">Set your available times for food rescue pickups</p>
            </div>
            <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
              {showAddAvailability && (
                <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
                  <h4 className="text-md font-medium text-gray-900 mb-4">Add New Availability Slot</h4>
              ...
              <div className="px-4 py-5 sm:px-6">
                {availability.length > 0 ? (
                    ...
                    <table className="min-w-full divide-y divide-gray-300">
                      ...
                      <tbody className="divide-y divide-gray-200 bg-white">
                        {availability.map((slot) => (
                          <tr key={slot.id}>
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">{slot.day}</td>
                            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{slot.startTime}</td>
                            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{slot.endTime}</td>
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="mt-1 text-sm text-gray-500">Add your available times to start receiving pickup assignments.</p>
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                <div>
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Confirm Account Deactivation</h3>
                    <div className="mt-2">
